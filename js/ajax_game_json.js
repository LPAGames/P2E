      ...
      success: function(data) {
        $.each(data, function(index, item) {
            ...
            var youtubeLink = $('<div class="card-img align-content-center w-100 m-0 p-0"' +
                'style="height: 60%;"><iframe class="w-100 h-100 m-0 p-0"src="https://www.youtube.com/embed/' +
                item.youtubeLink + '?autoplay=0&mute=1&controls=0"></iframe></div>');
            ...
            var cardPricePool = $('<div class="container d-flex align-items-center justify-content-around mb-1 ">' + 
              ...
              '<b>Price $<br />' + item.price + 
              '</b></p><pclass="card-subtitle text-center text-warning rounded bg-dark border border-warning shadow py-1 px-1">' +
